...
config.server.static.push({
  route: '/forge',
  path: path.join(__dirname, '..', 'node_modules', 'node-forge', 'js'),
});
config.server.static.push({
...
config.server.static.push({
  route: '/jsonld/jsonld.js',
  path: path.join(__dirname, '..', 'node_modules', 'jsonld', 'js', 'jsonld.js'),
  file: true
});
config.server.static.push({
  route: '/opencred-verifier/credentialVerifier.js',
  path: path.join(
    __dirname, '..', 'node_modules',
    'opencred-verifier', 'lib', 'credentialVerifier.js'),
  file: true
});
config.server.static.push({
  route: '/promise/promise.js',
  path: path.join(
    __dirname, '..', 'node_modules', 'es6-promise', 'dist', 'promise-1.0.0.js'),
  file: true
});
config.server.static.push({
  route: '/requirejs/require.js',
  path: path.join(__dirname, '..', 'node_modules', 'requirejs', 'require.js'),
  file: true
});
config.server.static.push({
