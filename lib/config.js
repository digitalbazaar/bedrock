...
// TODO: move to bedrock-requirejs
// requirejs config options
config.requirejs = {};
config.requirejs.bower = {};
config.requirejs.bower.componentsUrl = '/bower-components';
config.requirejs.bower.manifestFile = path.join(__dirname, '..', 'bower.json');
config.requirejs.bower.ignore = [];
config.requirejs.bower.bowerrc = {};
config.requirejs.bower.bowerrc.directory = path.join(
...
// TODO: remove once promise.polyfill() is called by es6-promise 2.0.1+
config.requirejs.config.deps = ['es6-promise'];
config.requirejs.config.callback = function(promise) {
  // FIXME: remove if done automatically by es6-promise 2.0.1+
  promise.polyfill();
  require(['requirejs/autoload'], function() {});
};
config.requirejs.configWrapperStart =
  './node_modules/bedrock-requirejs/configWrapper.start';
config.requirejs.configWrapperEnd =
  './node_modules/bedrock-requirejs/configWrapper.end';
// TODO: below should be provided by bedrock-views
...
// TODO: above should be provided by bedrock-views
