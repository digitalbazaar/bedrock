        ...
        async.auto({
          ...
          loadModules: ['httpsListen', 'httpListen', function(callback) {
            ...
            async.forEachSeries(moduleApis, function(moduleApi, callback) {
              ...
              // FIXME: check for moduleApi.init, call on bedrock.start event
          ...
          // FIXME: w/new event API, all modules should listening for
          ...
          events.on('bedrock.start', function() {
            ...
            events.emit('bedrock.started'); // DEPRECATE
            events.emit('bedrock.ready');
            if(done) {
              done(null);
            }
          });
