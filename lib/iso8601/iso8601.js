 ...
 * @param returnObject true to map values to keys and return an object instead
 *          of an array.
 */
iso8601.Period.parse = function(period, distributeOverflow, returnObject) {
    var duration = parsePeriodString(period, distributeOverflow);
    if (!returnObject) {
        return duration;
    }
    return {
...
if(_nodejs) {
  ...
  if(typeof global.iso8601 === 'undefined') {
    global.iso8601 = iso8601;
  }
}
