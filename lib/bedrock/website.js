...
function configureServer(app, callback) {
  ...
  // FIXME: If mail.js didn't use absolute paths this setDefaults would cause
  //        the loader to not be able to find the email templates.

  // set swig template engine defaults
  swig.setDefaults({
    autoescape: false,
  ...
  app.server.engine('html', consolidate.swig);
