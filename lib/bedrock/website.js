...
api.getDefaultViewVars = function(req, callback) {
  ...
  vars.clientData.contextUrl = bedrock.config.constants.contextUrl;
 ...
 *
 * server.param(':foo', bedrockIdParam)
 *
 * @param req the request.
 ...
 * @param id the id.
 */
api.bedrockIdParam = function(req, res, next, id) {
...
function configureServer(app, callback) {
  ...
  app.server.param(':identity', api.bedrockIdParam);
