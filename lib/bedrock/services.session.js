...
function addServices(app, callback) {
  ...
  app.server.get('/session/login', bedrock.website.makeResourceHandler());
  bedrock.docs.annotate.get('/session/login', {hide: true});
  ...
  bedrock.docs.annotate.post('/session/login', {
  ...
  bedrock.docs.annotate.get('/session/logout', {
  ...
  bedrock.docs.annotate.post('/session/password/reset', {
  ...
  bedrock.docs.annotate.get('/session/passcode', {hide: true});
  ...
  bedrock.docs.annotate.post('/session/passcode', {
