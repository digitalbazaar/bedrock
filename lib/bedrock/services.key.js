...
function addServices(app, callback) {
  app.server.post(bedrock.config.identity.basePath + '/:identity/keys',
    ensureAuthenticated,
  ...
  app.server.get(bedrock.config.identity.basePath + '/:identity/keys',
    function(req, res, next) {
      // get ID from URL
      var identityId = bedrock.identity.createIdentityId(req.params.identity);
      async.waterfall([
  ...
  app.server.post(bedrock.config.identity.basePath + '/:identity/keys/:publicKey',
    ensureAuthenticated,
  ...
  app.server.get(
    bedrock.config.identity.basePath + '/:identity/keys/:publicKey',
    function(req, res, next) {
      // get IDs from URL
      var identityId = bedrock.identity.createIdentityId(req.params.identity);
      var publicKeyId = bedrock.identity.createIdentityPublicKeyId(
