 ...
 *
 * @returns A resolver object that can be used by swig's 'loader' option.
 */
api.multipath = function(basepath, encoding) {
   ...
   * 
   * @returns the resolved path to the swig template file.
   */
   ...
   * 
   * @returns the contents of the file if callback is omitted.
   */
